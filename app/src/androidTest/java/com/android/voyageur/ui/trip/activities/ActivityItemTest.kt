...
class ActivityItemTest {
    ...
    fun activityItem_expandAndCollapse() {
        ...
        composeTestRule.onNodeWithText("${sampleActivityWithDescription.estimatedPrice} CHF").assertIsDisplayed()
    ...
    fun activityCard_displaysCorrectTitle() {
        ...
        composeTestRule.onNodeWithTag("cardItem_${sampleActivityWithDescription.title}").assertIsDisplayed()
    ...
    fun activityCard_doesNotDisplayDescription() {
        ...
        composeTestRule
            ...
            .assertIsDisplayed()
            .performClick()
        composeTestRule.onNodeWithTag("cardItem_${sampleActivityWithoutDescription.title}").assertIsDisplayed()
        composeTestRule.onNodeWithText(sampleActivityWithoutDescription.description).assertIsNotDisplayed()
    }
