 ...
 *
 * This repository interface abstracts the functionality to interact with the backend or
 * database for managing friend requests, such as retrieving, creating, and deleting requests.
 * It also includes real-time listening capabilities for friend request updates.
 */
