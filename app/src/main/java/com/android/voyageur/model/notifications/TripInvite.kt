 ...
 *
 * A `TripInvite` encapsulates the details of an invitation for a user to join a specific trip. It
 * includes information about the invite ID, the trip being invited to, the sender, the recipient,
 ...
 * @property accepted A flag indicating whether the invitation has been accepted. Defaults to
 *   `false`.
 */
