 ...
 *
 * The `TripInviteRepository` interface provides methods to perform CRUD operations for trip invites,
 * listen for real-time updates, and manage unique identifiers for invites.
 */
interface TripInviteRepository {
  ...
  fun init(onSuccess: () -> Unit)
     ...
     * @param onSuccess A callback invoked with a list of `TripInvite` objects when the retrieval is successful.
  ...
  fun getTripInvites(
     ...
     *
     * @param userId The unique identifier of the user.
     * @param onSuccess A callback invoked with the count of trip invites when the retrieval is successful.
     * @param onFailure A callback invoked with an exception if the retrieval fails.
     */
  ...
  fun getNewId(): String
     ...
     *
     * @param userId The unique identifier of the user.
     * @param onSuccess A callback invoked with a list of updated `TripInvite` objects when changes occur.
