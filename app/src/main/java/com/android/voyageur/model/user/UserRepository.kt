...
/**
 * Interface for interacting with the User data in the repository. Provides various methods to
 * perform CRUD operations on User data.
 */
interface UserRepository {
  /**
   * Initializes the User repository, typically used to set up any necessary connections or
   * listeners.
   *
